...
const PublishPage = lazyWithRetry(() => import("./pages/PublishPage"), "PublishPage");
const BulkImportPage = lazyWithRetry(() => import("./pages/BulkImportPage"), "BulkImportPage");
const AgencyPage = lazyWithRetry(() => import("./pages/AgencyPage"), "AgencyPage");
const LostPetsPage = lazyWithRetry(() => import("./pages/LostPetsPage"), "LostPetsPage");
...
const PublishServicePage = lazyWithRetry(() => import("./pages/PublishServicePage"), "PublishServicePage");
...
const CookiesPage = lazyWithRetry(() => import("./pages/CookiesPage"), "CookiesPage");
...
const PetPublicPage = lazyWithRetry(() => import("./pages/PetPublicPage"), "PetPublicPage");
